...
| US040           | Historial de pagos                            | Como empresa, <br>quiero que los clientes consulten su historial de pagos, <br>para brindar transparencia.                                                                                                                   | Given un cliente autenticado<br>When accede al historial de pagos<br>Then el sistema muestra todas las transacciones registradas con fecha y monto.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | E7                        |
...
| ------- | ------------- | ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 1       | US024         | Creación de viajes                          | Como administrador logístico, quiero crear viajes asignando vehículo y ruta, para planificar el transporte de mercancías.                       | 5            |
| 2       | US025         | Actualización de estados de viaje           | Como administrador logístico, quiero actualizar el estado de un viaje, para mantener informados a gerentes y clientes.                          | 5            |
| 3       | US026         | Reprogramación de viajes                    | Como administrador logístico, quiero reprogramar un viaje ya creado, para ajustar fechas y horarios.                                            | 5            |
| 4       | US027         | Código de viaje para cliente                | Como cliente final, quiero recibir un código único de viaje, para consultar fácilmente el estado de mi pedido.                                  | 5            |
| 5       | US013         | Registro de vehículos de carga              | Como administrador logístico, quiero registrar vehículos en la plataforma, para mantener un inventario actualizado de la flota.                 | 5            |
| 6       | US014         | Actualización de datos de vehículos         | Como administrador logístico, quiero editar la información de los vehículos, para mantener actualizado su estado operativo.                     | 3            |
| 7       | US015         | Eliminación de vehículos de carga           | Como administrador logístico, quiero eliminar vehículos de la plataforma, para mantener un inventario actualizado y evitar registros obsoletos. | 3            |
| 8       | US020         | Ver vehículos de carga                      | Como administrador logístico, quiero ver la lista de vehículos registrados, para supervisar y gestionar el inventario.                          | 3            |
| 9       | US016         | Registro de dispositivos IoT                | Como administrador logístico, quiero registrar un dispositivo IoT en la plataforma, para asociarlo a la flota y recibir datos.                  | 3            |
| 10      | US017         | Eliminar dispositivo IoT                    | Como administrador logístico, quiero eliminar un dispositivo IoT, para darlo de baja en caso de falla o reemplazo.                              | 3            |
| 11      | US018         | Asignar dispositivo a vehículo de carga     | Como administrador logístico, quiero asignar un dispositivo IoT a un vehículo de carga, para identificar transmisiones.                         | 3            |
| 12      | US019         | Cambiar dispositivo de vehículo             | Como administrador logístico, quiero reasignar un dispositivo IoT de un vehículo a otro, para reutilizarlo.                                     | 3            |
| 13      | US021         | Ver dispositivos IoT                        | Como administrador logístico, quiero ver la lista de dispositivos IoT registrados, para supervisar su estado.                                   | 3            |
| 14      | US022         | Ver estado de dispositivo por vehículo      | Como administrador logístico, quiero ver el estado de dispositivos por vehículo, para monitorear conectividad y funcionamiento.                 | 5            |
| 15      | US023         | Indicador físico en dispositivo (LED)       | Como usuario del dispositivo, quiero un indicador físico (LED), para verificar rápidamente si funciona sin depender de la app.                  | 8            |
| 16      | US028         | Actualización de temperatura en tiempo real | Como empresa, quiero recibir la temperatura en tiempo real de mis dispositivos IoT, para supervisar la cadena de frío.                          | 8            |
| 17      | US029         | Alertas por incumplimiento de temperatura   | Como cliente final, quiero recibir alertas cuando la temperatura sobrepasa los límites definidos, para tomar acciones correctivas.              | 5            |
| 18      | US030         | Alertas de conexión IoT                     | Como empresa, quiero recibir alertas cuando un dispositivo IoT deja de enviar datos, para actuar de inmediato.                                  | 5            |
| 19      | US031         | Roles y permisos de acceso                  | Como empresa, quiero que el sistema gestione roles y permisos de usuarios, para controlar accesos.                                              | 8            |
| 20      | US032         | Lista de viajes registrados                 | Como empresa, quiero ver una lista de todos los viajes registrados, para gestionarlos de forma rápida.                                          | 3            |
| 21      | US033         | Detalle de viaje                            | Como cliente final, quiero consultar el detalle de un viaje, para verificar información específica como ruta, estado y temperatura.             | 3            |
| 22      | US034         | Gráficos de tiempo y temperatura            | Como cliente final, quiero ver gráficos de evolución de la temperatura durante el viaje, para verificar el cumplimiento de parámetros.          | 5            |
| 23      | US035         | Gráficos de incidencias por mes             | Como empresa, quiero ver un gráfico mensual de incidencias, para identificar patrones de fallos.                                                | 5            |
| 24      | US036         | Filtrado de viajes por fecha                | Como empresa, quiero filtrar la lista de viajes por rango de fechas, para analizar un periodo específico.                                       | 3            |
| 25      | US037         | Descarga de reporte de viajes               | Como cliente final, quiero descargar un reporte en PDF de un viaje con su información y gráficos, para archivarlo o compartirlo.                | 5            |
...
| 28      | US040         | Historial de pagos                          | Como empresa, quiero que los clientes consulten su historial de pagos, para brindar transparencia.                                              | 3            |
...
| 30      | US001         | Navegación en landing page                  | Como visitante, quiero navegar entre secciones de la landing para acceder fácilmente a la información del servicio.                             | 5            |
| 31      | US002         | Sección portada                             | Como visitante, quiero ver una portada con mensaje principal, para entender rápidamente el propósito de la plataforma.                          | 3            |
| 32      | US003         | Sección de funcionalidades                  | Como visitante, quiero visualizar una sección con las funcionalidades principales, para conocer qué ofrece la plataforma.                       | 3            |
| 33      | US004         | Sección de beneficios                       | Como visitante, quiero ver una sección con beneficios, para entender qué valor obtengo al usar la plataforma.                                   | 2            |
| 34      | US005         | Sección de testimonios                      | Como visitante, quiero ver testimonios de otros clientes, para ganar confianza en el servicio.                                                  | 2            |
| 35      | US006         | Sección de contáctanos                      | Como visitante, quiero acceder a un formulario de contacto, para comunicarme con la empresa y solicitar más información.                        | 3            |
| 36      | US007         | Call to Action a la aplicación web          | Como visitante, quiero un botón de acceso a la app web, para registrarme o iniciar sesión desde navegador.                                      | 1            |
| 37      | US008         | Call to Action de descarga de App Móvil     | Como visitante, quiero botones de descarga de la app móvil, para instalarla en iOS o Android.                                                   | 1            |
| 38      | US009         | Registro de usuario                         | Como usuario, quiero registrarme en la plataforma, para acceder a mi cuenta y funcionalidades personalizadas.                                   | 3            |
...
| 40      | US011         | Cerrar sesión                               | Como usuario autenticado, quiero cerrar sesión, para que mi cuenta deje de estar accesible en el dispositivo actual.                            | 3            |
| 41      | US012         | Recuperar contraseña                        | Como usuario, quiero recuperar acceso a mi cuenta mediante restablecimiento de contraseña, para ingresar en caso de olvidar mis credenciales.   | 5            |
| 42      | TS001         | API de autenticación                        | Como developer, quiero endpoints de login/logout/refresh/validación de sesión para gestionar el acceso de forma segura.                         | 8            |
| 43      | TS002         | Servicio de autenticación con JWT           | Como developer, quiero implementar autenticación basada en JWT, para asegurar la comunicación entre cliente y servidor.                         | 8            |
| 44      | TS003         | API de vehículos de carga                   | Como developer, quiero exponer un endpoint para registrar, modificar y consultar vehículos, para que el backend gestione la flota.              | 8            |
| 45      | TS004         | API de dispositivos IoT                     | Como developer, quiero exponer un endpoint de dispositivos para registrar y administrar dispositivos IoT.                                       | 8            |
| 46      | TS005         | API de viajes                               | Como developer, quiero exponer un endpoint RESTful para registrar viajes, para que la aplicación guarde y gestione la información.              | 8            |
